...
<script type="text/javascript">
	$(function() {
		...
		$('#toggle-all').click(function() {
			...
			$('#AdminForm input[type=checkbox]').checkBox('toggle');
			return false;
		});
	});
</script>
...
<script src="<c:url value='/js/pages/admin.js' />"
	type="text/javascript"></script>
<script type="text/javascript">
	$(function() {
				...
				<tr>
					...
					<td>
						...
						<div id="content-table-inner">
							<form:form id="AdminForm" name="AdminForm" method="post" action="#"
								commandName="adminCommand">
								<c:if test="${not empty adminCommand.successMsg}">
									<div id="message-green">
										<table border="0" width="100%" cellpadding="0" cellspacing="0">
											<tr>
												<td class="green-left">${adminCommand.successMsg}
												</td>
										...
										<td>
											...
											<table border="0" cellpadding="0" cellspacing="0" id="id-form">
												<tr>
													...
													<td><form:errors path="username" cssClass="inp-form-error"/></td>
												</tr>
												<tr>
													<th valign="top">First name:</th>
													<td><form:input path="firstName" class="inp-form" /></td>
													<td><form:errors path="firstName" cssClass="inp-form-error"/></td>
												</tr>
												<tr>
													<th valign="top">Last name:</th>
													<td><form:input path="lastName" class="inp-form" /></td>
													<td><form:errors path="lastName" cssClass="inp-form-error"/></td>
												</tr>
												<tr>
													<th valign="top">Password</th>
													<td><form:password path="password" class="inp-form" /></td>
													<td><form:errors path="password" cssClass="inp-form-error"/></td>
												</tr>
												<tr>
													<th valign="top">Confirm Password:</th>
													<td><form:password path="confirmPassword" class="inp-form" /></td>
													<td><form:errors path="confirmPassword" cssClass="inp-form-error"/></td>
												</tr>
												<tr>
														...
														<table border="0" cellpadding="0" cellspacing="0">
															<tr valign="top">
																...
																<td><a href="" id="date-pick">
																	<img src="<c:url value='/images/forms/icon_calendar.jpg' />"
																		alt="calender" /> </a>
																</td>
															</tr>
														</table>
												...
												<tr>
													<th>&nbsp;</th>
													<td valign="top">
														<input id="AdminForm_submit" type="button" class="form-next" onclick='javascript:addNewUser()'/>

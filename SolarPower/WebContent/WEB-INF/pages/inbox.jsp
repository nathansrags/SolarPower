...
<script type="text/javascript" charset="utf-8">
  $(function() {
      $("input.file_1").filestyle({ 
          image: "<c:url value='/images/forms/choose-file.gif' />",
          imageheight : 21,
          imagewidth : 78,
          width : 310
      });
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<td class="red-right"><a class="close-red"><img src="<c:url value='/images/table/icon_close_red.gif' />"   alt="" /></a></td>
				</tr>
				</table>
				</div>
				<!--  end message-red -->
				...
				<tr>
					...
					<td class="blue-right"><a class="close-blue"><img src="<c:url value='/images/table/icon_close_blue.gif' />"   alt="" /></a></td>
				</tr>
				</table>
				</div>
				<!--  end message-blue -->
				...
				<tr>
					...
					<td class="green-right"><a class="close-green"><img src="<c:url value='/images/table/icon_close_green.gif' />"   alt="" /></a></td>
				</tr>
				</table>
				</div>
				<!--  end message-green -->

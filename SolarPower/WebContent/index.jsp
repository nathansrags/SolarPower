...
<%-- <jsp:include page="WEB-INF/pages/tagLib.jsp" /> --%>
...
<!--  jquery core -->
<script src="<c:url value='/js/jquery/jquery-1.4.1.min.js' />"
		...
		<div id="loginbox">
			...
			<div id="login-inner">
				...
				<table border="0" cellpadding="0" cellspacing="0">
					<tr>
						<th>Username</th>
						<td><input type="text" id="username" name="j_username" class="login-inp" value="admin"/>
						</td>
					</tr>
					<tr>
						<th>Password</th>
						<td><input type="password" id="password" name="j_password" class="login-inp" value="admin"/>
						</td>
					</tr>
					<tr>
						<th></th>
		...
		<div id="forgotbox">
			...
			<div id="forgot-inner">
				<table border="0" cellpadding="0" cellspacing="0">
					<tr>
						<th>Email address:</th>
						<td><input type="text" value="" class="login-inp" />
						</td>
					</tr>
					<tr>
						<th></th>
